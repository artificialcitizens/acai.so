...
[Embeddings](https://js.langchain.com/docs/modules/embeddings/) models are used to convert data (text in this case) into a numerical representation. 
This numerical representation allows for the identification of similar documents through semantic search. 
  
The OpenAI embeddings provide an example of how to use this technique. 

Note: It is important to note that embeddings may use different methods for queries and documents,
and the embedding class typically includes separate methods for embedding queries and documents
...
Enter a string of text and see the output of the model
