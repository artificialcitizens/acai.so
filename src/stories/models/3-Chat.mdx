...
<p>There are fourtypes of ChatMessages:</p>
<ul>
...
export const run = async () => {
  ...
  const response = await chat.call([
    ...
    new HumanChatMessage(
      `What is a good name for a company that makes enterprise level design systems?
      (Hint: it is Knapsack)`,
    ),
  ]);
...
<div className="link-list">
  <a className="link-item" href="https://storybook.js.org/docs/react/addons/addon-types" target="_blank">
    <span>
      ...
      Chat models are used for conversational interfaces and chatbots
    </span>
  </a>
  ...
  <a className="link-item" href="https://storybook.js.org/docs/react/configure/styling-and-css" target="_blank">
    <span>
      ...
      We use LLMs to create embeddings that we can store for data augmented chains
    </span>
  </a>
</div>
